...
cell_ids = T_mat(2:180,1);
SPNPs = T_mat(2:180,2);
C_nt = T_mat(1:179,3:end);
...
C_nt_hom = T_mat_hom(1:179,3:end);
...
%% Plot the data
cell_choose = 43; %Choose the cell [1-529]
...
filename = 'Tau_values_WT_DRG_10sec.xlsx';
